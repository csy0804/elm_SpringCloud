...
public class BusinessController {
    ...
    @GetMapping("/listBusinessByBusinessName/{businessName}")
    public CommonResult<List> listBusinessByBusinessName(@PathVariable("businessName") String businessName) throws Exception {
        List<Business> list = businessService.listBusinessByBusinessName(businessName);
        return new CommonResult(200, "success", list);
    }
